...
function SET_STATE(state, { keyPath, data }) {
  set(state, keyPath, data);
}

const vuexStoreMixin = {
  mutations: {
    SET_STATE,
  },
};
...
function linkVuexState(keyPath, defaultValue) {
...
const mixinStoreModule = (moduleName, moduleDefinition) => ({
  beforeCreate() {
...
const extendState = (proto, overwrite) => {
...
const extendModule = (proto, overwrite) =>
...
exports.vuexPlugin = vuexPlugin;
exports.SET_STATE = SET_STATE;
exports.vuexStoreMixin = vuexStoreMixin;
exports.isUndef = isUndef;
exports.isPrimitive = isPrimitive;
exports.hasOwn = hasOwn;
exports.linkVuexState = linkVuexState;
exports.mixinStoreModule = mixinStoreModule;
